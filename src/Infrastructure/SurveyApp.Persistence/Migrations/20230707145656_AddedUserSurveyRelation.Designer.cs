...
namespace SurveyApp.Persistence.Migrations
{
    ...
    [Migration("20230707145656_AddedUserSurveyRelation")]
    partial class AddedUserSurveyRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurveyApp.Domain.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("SurveyApp.Domain.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SurveyApp.Domain.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SurveyApp.Domain.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SurveyApp.Domain.Entities.Survey", b =>
                {
                    b.HasOne("SurveyApp.Domain.Entities.AppUser", "AppUser")
                        .WithMany("Surveys")
